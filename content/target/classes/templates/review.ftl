...
<!-- teacher name and average rating card 1 -->
        <div class="row">
...
<!-- writing review card and rating -->
    <#assign tmp = 0>
...
<#assign tmp = 1>
    ...
    <div class="row mt-5" id="myDIV">
        <div class="card-sm-4 shadow mx-auto text-center " style="width: 50rem;">
            <div class="card-body">
                <h5 class="card-title">Review: ${teacher.getName()}</h5>
                <form method="post" action="teachers/${teacher.getId()}/reviews/edit">
    ...
    <!-- card for yours and others reviews -->
    <div class="row mt-5">
