...
<@c.page " | " + subject.getCode()>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="container pb-4" id="cardSection">
                ...
                <div class="card col-md-12">
                    ...
                    <div class="collapse multi-collapse mb-2 mt-2" id="homeworkSection">
                        <div class="row mb-2">
                            ...
                            <div class="col" style="text-align: right">
                                <button class="btn btn-outline-primary" type="button" data-toggle="modal"
                                        data-target="#addHomework">Add Homework
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="modal fade" id="addHomework" tabindex="-1" aria-labelledby="addHomework"
                             aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="/subjects/${subject.getCode()}" method="post">
                                            <div class="form-group">
                                                ...
                                                <label for="hwDescription"
                                                       style="visibility: hidden">Description</label>
                                                <input type="text" name="type" id="hwDescription" value="HOMEWORK"
                                        ...
                                        <form action="/subjects/${subject.getCode()}" method="post">
                                            <div class="form-group">
                                                ...
                                                <label for="testDescription"
                                                       style="visibility: hidden">Description</label>
                                                <input type="text" name="type" id="testDescription" value="TEST"
                                                       style="visibility: hidden">
                                            </div>
                                        ...
                                        <form action="/subjects/${subject.getCode()}" method="post">
                                            <div class="form-group">
                                                ...
                                                <label for="examDescription"
                                                       style="visibility: hidden">Description</label>
                                                <input type="text" name="type" id="testDescription" value="EXAM"
                                                       style="visibility: hidden">
                                            </div>
                ...
                <div class="mt-3">
                    ...
                    <#if assigned == true>
                        <form action="/subjects/${subject.getCode()}/delAssignment" method="post"
                            ...
                            <input type="hidden" name="_csrf" value="${_csrf.token}"/>
                            <div class="mt-2 ml-4 text-center">
                                <button type="submit" class="btn btn-danger">Remove from My Subjects
                                </button>
                            </div>
                        </form>
                    </#if>
