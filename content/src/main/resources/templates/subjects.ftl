...
<@c.page>
    ...
    <div class="row" style="padding: 0 0 30px 0">
        ...
        <div class="dropdown">
            ...
            <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2">Add Subject</button>
